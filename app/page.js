...
export default function Home() {
  ...
  // Redirect automat la dashboard dacă userul este deja logat
  useEffect(() => {
  ...
  // Loading state discret în stilul FPLAYT
  if (status === 'loading') {
    return (
  ...
  // Dacă e deja logat, nu mai randăm restul paginii
  if (status === 'authenticated') return null;

  return (
    <div className="dark bg-[#0F0D0D] text-[#e8e1e0] min-h-screen flex flex-col overflow-x-hidden font-['Inter']">
      <style jsx global>{`
        .vignette-glow {
      ...
      {/* Navbar - Curățat de elemente extra */}
      ...
      <main className="flex-grow flex items-center justify-center relative px-6 py-20">
        ...
        <div className="relative w-full max-w-[440px] bg-[#1A1614] rounded-xl border border-[#2E2724] shadow-2xl overflow-hidden before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-[2px] before:bg-[#C0392B]">
          <div className="p-10 space-y-8">
            ...
            <div className="bg-[#231E1C] rounded-lg border border-[#2E2724] p-5 space-y-4 text-left">
                ...
                <div>
                  ...
                  <ul className="mt-1 space-y-2">
                    <li className="text-[12px] text-[#8A7E7C] flex items-center gap-2 font-medium">
                      <div className="w-1 h-1 rounded-full bg-[#C0392B]"></div>
            ...
            <div className="flex flex-col gap-3 pt-2">
              <button 
                ...
                className="w-full py-4 bg-[#C0392B] text-[#F0EAE8] rounded-lg font-black text-sm flex items-center justify-center gap-3 hover:bg-[#A93226] transition-all active:scale-[0.98] shadow-lg shadow-[#C0392B]/10 uppercase tracking-widest"
              >
      ...
      <footer className="fixed bottom-4 w-full flex justify-center items-center pointer-events-none">
